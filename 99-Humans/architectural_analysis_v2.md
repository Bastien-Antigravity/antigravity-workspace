...
- **Prevention**:
  - Implement a strict, hardcoded blacklist in [src/core/security.py](file:///Users/imac/Desktop/Bastien-Antigravity/obsidian-brain/src/core/security.py) and [src/core/mcp.py](file:///Users/imac/Desktop/Bastien-Antigravity/obsidian-brain/src/core/mcp.py) that automatically intercepts any access attempt to files matching: `.env`, `*.pem`, `id_rsa`, `config.json`, `.git`, or `node_modules`, regardless of the active Mode or workspace configuration.
...
- **Prevention**:
  - Persist the active session ID in a local cache or write it to [00-AI-Orchestration/AI-Session-State.md](file:///Users/imac/Desktop/Bastien-Antigravity/obsidian-brain/00-AI-Orchestration/AI-Session-State.md).
...
- **Vulnerability**: The metadata auditor [sovereignty.py](file:///Users/imac/Desktop/Bastien-Antigravity/obsidian-brain/08-Base-Scripts/lib/sovereignty.py) relies on hardcoded folder structures to determine frontmatter validation rules:
  ```python
