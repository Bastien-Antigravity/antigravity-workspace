...
4. **Cognitive Enrichment & Routing**: Route code blocks to the RAG vector store with clear `is_code: True` and parent-child metadata.
...
---
*Reference: [[ast-chunker]], [[ai-augmenter]], [[09-RAG-Engine/README]]*
