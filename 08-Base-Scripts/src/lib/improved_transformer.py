...
class CodeTransformer:
    ...
    # -----------------------------------------------------------------------------------------------
    def __init__(self, config: object, logger: object, name: str = None):
        self.config = config
        self.logger = logger
    ...
    def transform(self, *, code: str, class_name: str = "GeneratedModule") -> str:
        ...
        """
        self.logger.info("{0} : beginning transformation".format(self.Name))
        ...
        self.logger.info("{0} : transformation completed successfully".format(self.Name))
        return code
