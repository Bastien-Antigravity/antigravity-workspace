...
def _load_governance_context(active_repo_dir: str) -> str:
    ...
    # 1. Global context
    global_files = [
        ("Global Ecosystem Map MOC", osPathJoin(VAULT_ROOT, "Ecosystem-Map-MOC.md")),
        ("Global AI Session State", osPathJoin(VAULT_ROOT, "00-AI-Orchestration", "AI-Session-State.md"))
    ]
