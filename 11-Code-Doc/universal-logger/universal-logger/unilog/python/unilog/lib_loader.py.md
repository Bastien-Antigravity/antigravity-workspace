...
- [[universal-logger/universal-logger/unilog/python/unilog/lib_loader.py.md|CALLBACK_TYPE]] (constant: belongs_to)
- [[universal-logger/universal-logger/unilog/python/unilog/lib_loader.py.md|_load_lib]] (function: belongs_to)
<!-- SYNC:END -->
