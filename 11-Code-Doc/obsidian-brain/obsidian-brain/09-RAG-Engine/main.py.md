...
### 🔌 Consumers (Inbound)
- [[obsidian-brain/obsidian-brain/05-Fleet-Operation/00-Repo-Control/build-inventory.py.md|build-inventory.py]] (calls)
- [[obsidian-brain/obsidian-brain/05-Fleet-Operation/00-Repo-Control/fleet-refresh.py.md|fleet-refresh.py]] (calls)
