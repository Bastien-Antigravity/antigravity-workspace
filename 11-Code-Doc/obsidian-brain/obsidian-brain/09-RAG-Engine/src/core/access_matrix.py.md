...
### 🔌 Consumers (Inbound)
- [[obsidian-brain/obsidian-brain/09-RAG-Engine/src/core/access_matrix.py.md|_CORE_DIR]] (constant: belongs_to)
...
- [[obsidian-brain/obsidian-brain/09-RAG-Engine/src/core/access_matrix.py.md|_load_access_matrix]] (function: belongs_to)
